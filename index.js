...
Converge.prototype.collectPayment = function (firstName, lastName, email, cardNumber, expirationDate, cvv, amount, invoiceNumber, description) { 
    ...
    xmlTransaction += '<ssl_exp_date>' + expirationDate+ '</ssl_exp_date>\n'; 
...
Converge.prototype.generateToken = function (firstName, lastName, email, cardNumber, expirationdate, cvv,address,zip) { 
    var deferred = Q.defer(); 
    //build txn node 
    var xmlTransaction = ''; 
    xmlTransaction += 'xmldata=<txn>\n'; 
...
Converge.prototype.verifyCard = function (cardNumber, expirationDate, cvv,address,zip) { 
 ...
 Converge.prototype.getCard = function (token) { 
    //console.log('expiration date ', expirationDate); 
    var deferred = Q.defer(); 
    //build txn node 
    var xmlTransaction = ''; 
