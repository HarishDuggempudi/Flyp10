...
import { RegisterUserModel,UserModel, UserResponse,JudgesResponse,JudgeSportModel } from "./user.model";
import { Router } from '@angular/router';
import { MatPaginator, MatTableDataSource, MatSelectModule } from '@angular/material';

@Component({
    selector: 'Recruiter-Rejected',
    templateUrl: './recruiter-rejected.html'
})
export class RecruiterrejectedComponent implements OnInit {
    ...
    ngOnInit() {
		this.getRejectedRecruiter();
    }
	
	 getRejectedRecruiter() {
        this._Service.getRejectedRecruiter(this.perPage,this.currentPage)
