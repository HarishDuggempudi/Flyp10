...
export class UserunVerifyComponent implements OnInit {
    
    displayedColumns = ['SN', 'Username', 'Sport', 'Level', 'Verification Document', 'Actions'];    
    dataSource: any;    
    userId: string;
...
totaldataItem:any
    ...
    ngOnInit() {
	 ...
	 getunVerfiedUserList() {
        this._Service.getunverifiedJudgesSport(this.perPage,this.currentPage)
