...
@Component({
    selector: 'Recruiter-UnVerify',
    templateUrl: './recruiter-unverified.html'
})
export class RecruiterunVerifyComponent implements OnInit {
    ...
    ngOnInit() {
		this.getUnVerifiedRecruiter();
    }
	
	 getUnVerifiedRecruiter() {
        this._Service.getUnVerifiedRecruiter(this.perPage,this.currentPage)
