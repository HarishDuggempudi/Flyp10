...
@Component({
  selector: "inappropriate-routine-list",
  templateUrl: "./inappropriateRoutine.html",
  styleUrls: ['../routine-list.scss']
})
export class InappropriateRoutineListComponent implements OnInit {
    ...
    ngOnInit() {
         ...
         getRoutine() {
             this._Service.getAllinAppeopriateRoutine(this.perPage,this.currentPage)
