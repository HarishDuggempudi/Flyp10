...
export class NewRoutineListComponent implements OnInit {
  ...
  uploadingType: any;
    ...
    constructor(private _objService: EventMeetService,private route:Router,private activatedRoute:ActivatedRoute,private _Service:AdminRoutineService,private walletservice: WalletService,private sportService:SportService){
    ...
    ngOnInit() {
      this.activatedRoute.params.subscribe(param=>{
        ...
        this.getNewRoutine();
         ...
         getNewRoutine() {
             this._Service.getAllnewRoutine(this.perPage,this.currentPage,this.uploadingType)
