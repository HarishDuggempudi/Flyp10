...
@Component({
  selector: "assigned-routine-list",
  templateUrl: "./assignedRoutine.html",
  styleUrls: ['../routine-list.scss']
})
export class AssignedRoutineListComponent implements OnInit {
    displayedColumns = ['SN', 'Title','RoutineId','Athlete','AssignedTo','UploadedOn','AssignedOn','Actions'];    
    dataSource: any;    
    userId: string;
    ...
    ngOnInit() {
         ...
         getRoutine() {
             this._Service.getAllassignedRoutine(this.perPage,this.currentPage)
