...
import {ScoreComponent} from "../admin-app/dashboard-app/components/judges-routines/score.component"
...
@NgModule({
  imports: [BrowserModule,
    ...
    AdminAppRoutingModule,MatSliderModule
  ],
  declarations: [AdminAppComponent,
    ...
    VerifyUserComponent,ScoreComponent,
