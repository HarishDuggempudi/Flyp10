...
export class LoginService {
  ...
  private _activationMailUrl: string = API_URL + 'resendActivation';  // URL to web api
  ...
  resendActivationMail = (objLogin): Observable<any>=> {
    let body = JSON.stringify(objLogin);
    return this.http.post(this._activationMailUrl, body)
      .pipe(
          catchError(this.handleError)
      );
    //    .catch(this.handleError);
