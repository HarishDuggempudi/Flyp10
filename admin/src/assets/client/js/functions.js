...
$("#submit_btn").click(function() {
   ...
   // }
    ...
    if (proceed) {
        ...
        post_data = {"fullName":user_name,"email":user_email,"contactNumber":user_phone,"organizationName":"none","informationSource":"none","message":user_message};
      
        //Ajax post data to server
        $.post('https://flyp10.com/api/contact/info/', post_data, function(response) {
           console.log(response)
            //load json data from server and output message
            if (response.type == 'error') {
                output = '<div class="alert-danger" style="padding:10px; margin-bottom:25px;">' + response.message + '</div>';
            } else {
                output = '<div class="alert-success" style="padding:10px; margin-bottom:25px;">' + response.message + '</div>';
