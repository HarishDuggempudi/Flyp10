...
! function(a) {
    ...
    jQuery.extend(!0, b, {
        preLoadAudio: function(a, c) {
            return "stop" !== b.compare_version(e).check && void a.find(".tp-audiolayer").each(function() {
                var a = jQuery(this),
                    d = {};
        ...
        resetVideo: function(a, d, e) {
            ...
            switch (g.videotype) {
                case "youtube":
                    ...
                    0 == a.find(".tp-videoposter").length && 1 !== g.bgvideo && e !== !0 && punchgs.TweenLite.to(a.find("iframe"), .3, {
                        autoAlpha: 1,
                        display: "block",
            ...
            switch (d.videotype) {
                case "youtube":
                    if (0 == a.find("iframe").length) a.append(a.data("videomarkup")), i(a, c, !0);
                        ...
                        1 == a.data("nextslideatend-triggered") && (h = -1, a.data("nextslideatend-triggered", 0)), e != -1 && e > h && d.player.seekTo(e), d.youtubepausecalled !== !0 && d.player.playVideo()
                    } else a.data("videoplaywait", setTimeout(function() {
                        d.youtubepausecalled !== !0 && b.playVideo(a, c)
                    }, 50));
                    break;
                case "vimeo":
                    if (0 == a.find("iframe").length) a.append(a.data("videomarkup")), i(a, c, !0);
                        ...
                        void 0 == k.api("play") ? a.data("videoplaywait", setTimeout(function() {
                            d.vimeopausecalled !== !0 && b.playVideo(a, c)
                        }, 50)) : setTimeout(function() {
                            k.api("play");
                            var b = f(a.data("videostartat")),
                                c = a.data("currenttime");
                            1 == a.data("nextslideatend-triggered") && (c = -1, a.data("nextslideatend-triggered", 0)), b != -1 && b > c && k.api("seekTo", b)
                        }, 510)
                    } else a.data("videoplaywait", setTimeout(function() {
                        d.vimeopausecalled !== !0 && b.playVideo(a, c)
                    }, 50));
                ...
                case "html5":
                    var l = "html5" == d.audio ? "audio" : "video",
                        ...
                        n = m[0],
                        o = m.parent();
                    if (1 != o.data("metaloaded")) g(n, "loadedmetadata", function(a) {
                        b.resetVideo(a, c), n.play();
                        var d = f(a.data("videostartat")),
                            e = n.currentTime;
                        1 == a.data("nextslideatend-triggered") && (e = -1, a.data("nextslideatend-triggered", 0)), d != -1 && d > e && (n.currentTime = d)
                    }(a));
                    else {
                        n.play();
                        var e = f(a.data("videostartat")),
                            h = n.currentTime;
                        1 == a.data("nextslideatend-triggered") && (h = -1, a.data("nextslideatend-triggered", 0)), e != -1 && e > h && (n.currentTime = e)
                    }
            }
        },
        ...
        manageVideoLayer: function(a, h, j, k) {
            if ("stop" === b.compare_version(e).check) return !1;
            var m = a.data(),
                n = m.videoattributes,
                o = m.ytid,
                p = m.vimeoid,
                q = "auto" === m.videopreload || "canplay" === m.videopreload || "canplaythrough" === m.videopreload || "progress" === m.videopreload ? "auto" : m.videopreload,
                r = m.videomp4,
                s = m.videowebm,
                t = m.videoogv,
                u = m.allowfullscreenvideo,
                v = m.videocontrols,
                w = "http",
                x = "loop" == m.videoloop ? "loop" : "loopandnoslidestop" == m.videoloop ? "loop" : "",
                y = void 0 != r || void 0 != s ? "html5" : void 0 != o && String(o).length > 1 ? "youtube" : void 0 != p && String(p).length > 1 ? "vimeo" : "none",
                z = "html5" == m.audio ? "audio" : "video",
                A = "html5" == y && 0 == a.find(z).length ? "html5" : "youtube" == y && 0 == a.find("iframe").length ? "youtube" : "vimeo" == y && 0 == a.find("iframe").length ? "vimeo" : "none";
            switch (x = m.nextslideatend === !0 ? "" : x, m.videotype = y, A) {
                case "html5":
                    "controls" != v && (v = "");
                    var z = "video";
                    "html5" == m.audio && (z = "audio", a.addClass("tp-audio-html5"));
                    var B = d && h.fallbacks.allowHTML5AutoPlayOnAndroid ? "muted" : "",
                        C = "<" + z + " " + B + ' style="object-fit:cover;background-size:cover;visible:hidden;width:100%; height:100%" class="" ' + x + ' preload="' + q + '">';
                    "auto" == q && (h.mediapreload = !0), void 0 != s && "firefox" == b.get_browser().toLowerCase() && (C = C + '<source src="' + s + '" type="video/webm" />'), void 0 != r && (C = C + '<source src="' + r + '" type="video/mp4" />'), void 0 != t && (C = C + '<source src="' + t + '" type="video/ogg" />'), C = C + "</" + z + ">";
                    var D = "";
                    "true" !== u && u !== !0 || (D = '<div class="tp-video-button-wrap"><button  type="button" class="tp-video-button tp-vid-full-screen">Full-Screen</button></div>'), "controls" == v && (C += '<div class="tp-video-controls"><div class="tp-video-button-wrap"><button type="button" class="tp-video-button tp-vid-play-pause">Play</button></div><div class="tp-video-seek-bar-wrap"><input  type="range" class="tp-seek-bar" value="0"></div><div class="tp-video-button-wrap"><button  type="button" class="tp-video-button tp-vid-mute">Mute</button></div><div class="tp-video-vol-bar-wrap"><input  type="range" class="tp-volume-bar" min="0" max="1" step="0.1" value="1"></div>' + D + "</div>"), a.data("videomarkup", C), a.append(C), (c && 1 == a.data("disablevideoonmobile") || b.isIE(8)) && a.find(z).remove(), a.find(z).each(function(c) {
                        var d = this,
                            e = jQuery(this);
                        ...
                        var f = e.parent();
                        1 != f.data("metaloaded") && g(d, "loadedmetadata", function(a) {
                            l(a, h), b.resetVideo(a, h)
                        }(a))
                    });
                    break;
                case "youtube":
                    w = "https", "none" == v && (n = n.replace("controls=1", "controls=0"), n.toLowerCase().indexOf("controls") == -1 && (n += "&controls=0")), m.videoinline !== !0 && "true" !== m.videoinline && 1 !== m.videoinline || (n += "&playsinline=1");
                    var E = f(a.data("videostartat")),
                        F = f(a.data("videoendat"));
                    E != -1 && (n = n + "&start=" + E), F != -1 && (n = n + "&end=" + F);
                    var G = n.split("origin=" + w + "://"),
                        H = "";
                    G.length > 1 ? (H = G[0] + "origin=" + w + "://", self.location.href.match(/www/gi) && !G[1].match(/www/gi) && (H += "www."), H += G[1]) : H = n;
                    var I = "true" === u || u === !0 ? "allowfullscreen" : "";
                    a.data("videomarkup", '<iframe type="text/html" src="' + w + "://www.youtube.com/embed/" + o + "?" + H + '" ' + I + ' width="100%" height="100%" style="opacity:0;visibility:hidden;width:100%;height:100%"></iframe>');
                    break;
                case "vimeo":
                    w = "https", a.data("videomarkup", '<iframe src="' + w + "://player.vimeo.com/video/" + p + "?autoplay=0&" + n + '" webkitallowfullscreen mozallowfullscreen allowfullscreen width="100%" height="100%" style="opacity:0;visibility:hidden;100%;height:100%"></iframe>')
            }
            var J = c && "on" == a.data("noposteronmobile");
            if (void 0 != m.videoposter && m.videoposter.length > 2 && !J) 0 == a.find(".tp-videoposter").length && a.append('<div class="tp-videoposter noSwipe" style="cursor:pointer; position:absolute;top:0px;left:0px;width:100%;height:100%;z-index:3;background-image:url(' + m.videoposter + '); background-size:cover;background-position:center center;"></div>'), 0 == a.find("iframe").length && a.find(".tp-videoposter").click(function() {
                if (b.playVideo(a, h), c) {
                ...
                0 != a.find("iframe").length || "youtube" != y && "vimeo" != y || (a.append(a.data("videomarkup")), i(a, h, !1))
            }
    ...
    var g = function(a, b, c) {
        ...
        i = function(a, d, e) {
            ...
            if (i.attr("id", l), e && a.data("startvideonow", !0), 1 !== a.data("videolistenerexist")) switch (g.videotype) {
                        ...
                        events: {
                            onStateChange: function(c) {
                                ...
                                if (c.data == YT.PlayerState.PLAYING) punchgs.TweenLite.to(a.find(".tp-videoposter"), .3, {
                                    ...
                                    display: "block",
                                    ease: punchgs.Power3.easeInOut
                                }), "mute" == a.data("volume") || b.lastToggleState(a.data("videomutetoggledby")) || d.globalmute === !0 ? r.mute() : (r.unMute(), r.setVolume(parseInt(a.data("volume"), 0) || 75)), d.videoplaying = !0, m(a, d), p ? d.c.trigger("stoptimer") : d.videoplaying = !1, d.c.trigger("revolution.slide.onvideoplay", h(r, "youtube", a.data())), b.toggleState(g.videotoggledby);
                                else {
                                    if (0 == c.data && o) {
                                        var s = f(a.data("videostartat"));
                                        s != -1 && r.seekTo(s), r.playVideo(), b.toggleState(g.videotoggledby)
                    ...
                    y.addEvent("ready", function() {
                        if (a.addClass("rs-apiready"), y.addEvent("play", function(c) {
                                a.data("nextslidecalled", 0), punchgs.TweenLite.to(a.find(".tp-videoposter"), .3, {
                                    ...
                                    display: "block",
                                    ease: punchgs.Power3.easeInOut
                                }), d.c.trigger("revolution.slide.onvideoplay", h(y, "vimeo", a.data())), d.videoplaying = !0, m(a, d), p ? d.c.trigger("stoptimer") : d.videoplaying = !1, "mute" == a.data("volume") || b.lastToggleState(a.data("videomutetoggledby")) || d.globalmute === !0 ? y.api("setVolume", "0") : y.api("setVolume", parseInt(a.data("volume"), 0) / 100 || .75), b.toggleState(g.videotoggledby)
                ...
                switch (g.videotype) {
                    case "youtube":
                        e && (g.player.playVideo(), z != -1 && g.player.seekTo());
                        break;
                    case "vimeo":
                        if (e) {
        ...
        l = function(a, e, i) {
            ...
            if (s = "loop" == s || "loopandnoslidestop" == s, r.data("metaloaded", 1), 1 != a.data("bgvideo") || "none" !== l.videoloop && l.videoloop !== !1 || (t = !1), void 0 == p.attr("control") && (0 != a.find(".tp-video-play-button").length || c || a.append('<div class="tp-video-play-button"><i class="revicon-right-dir"></i><span class="tp-revstop">&nbsp;</span></div>'), a.find("video, .tp-poster, .tp-video-play-button").click(function() {
            ...
            void 0 != v && g(v, "click", function() {
                ...
                var b = 100 / q.duration * q.currentTime,
                    ...
                    d = q.currentTime;
                if (void 0 != y && (y.value = b), 0 != c && c != -1 && Math.abs(c - d) <= .3 && c > d && 1 != a.data("nextslidecalled"))
                    if (s) {
                        q.play();
                ...
                var c = a.data("volume");
                // c = void 0 != c && "mute" != c ? parseFloat(c) / 100 : c, d || (e.globalmute === !0 ? q.muted = !0 : q.muted = !1, c > 1 && (c /= 100), "mute" == c ? q.muted = !0 : void 0 != c && (q.volume = c)), a.addClass("videoisplaying");
                ...
                var d = "html5" == l.audio ? "audio" : "video",
                    f = k();
                !f && a.find(".tp-videoposter").length > 0 && "on" == a.data("showcoveronpause") && !a.hasClass("seekbardragged") && (punchgs.TweenLite.to(a.find(".tp-videoposter"), .3, {
                    autoAlpha: 1,
                    force3D: "auto",
                    ease: punchgs.Power3.easeInOut
