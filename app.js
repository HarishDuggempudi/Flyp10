...
var express = require('express'),
    ...
    JobController = require('./lib/controllers/job.schduler.controller'),
...
/**
 * Cron job for daily world meet
 * job start at mid night 11:59
 *  */
cron.schedule("59 23 * * *", function() {
    console.log("awardRoutine job run On-" + new Date().toString());
    JobController.awardRoutine();

});

/**
 * Cron job for file conversion
 * job start at every 15 min
 *  */
cron.schedule("*/15 * * * *", function() {
    console.log("convertRoutine job run On-" + new Date().toString());
    JobController.convertRoutine();
...
/**
 * Cron job for file conversion
 * job start at every 30 min
 *  */
cron.schedule("*/20 * * * *", function() {
    console.log("updateRoutine job run On-" + new Date().toString());
    JobController.updateRoutine();

});

cron.schedule("*/20 * * * *", function() {
    console.log("updatefinalScore");
    JobController.updatefinalScore();
