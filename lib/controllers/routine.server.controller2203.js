var routineController = (function() {
            ...
            dataProviderHelper.checkForDuplicateEntry(Routine, _query)
                .then(function(count) {
                    ...
                    if (count > 1) {
                        ...
                        _p.removeEventMeetForJudging(req,res,next)
                    }
                })
                .then(function() {
                    res.status(HTTPStatus.OK);
    ...
    _p.updateeteventmeetjudgingfromxlsx = async function(req, res) {
            ...
            const fs = require('fs');
            var path = req.app.get('rootDir') + '/lib/configs/IrishDanceTableUpdate.xlsx';
            ...
            var RoutineSSC = result.EventMeetForJudging;
            ...
            if (ej) {
                for (var j = 0; j < ej.length; j++) {
                    //console.log(ej, j, 'test')
                    ej[j].deleted = true;
                    dataProviderHelper.save(ej[j]);
                }
    ...
    function getData(data) {
        ...
        return new Promise((resolve, reject) => {
            var query = {}
                //  //console.log(data['N'])
            query.judgeid = mongoose.Types.ObjectId('5dc56f1e724ea213ec8bce08')
            query.routineid = mongoose.Types.ObjectId('5f794882e208ce7ac70f3e70')
            dataProviderHelper.find(RoutineComment, query).then((res) => {
                //  //console.log(res,"res")
                resolve(res)
            })
        });
