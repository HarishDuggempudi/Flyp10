(function (pageViewController) {
    ...
    var Promise = require('bluebird'),
        ...
        sportController = require("../sport.server.controller"),
    ...
    pageViewController.init = function (app) {
        ...
        pageViewController.getTestimonialsPageData = function (req, next) {
            ...
            return join(
                ...
                function (commonData, testimonialData) {
                    console.log('testimonial page data', testimonialData);
                    return {
                        commonData: commonData,
        ...
        pageViewController.getSportsPageData = function (req, next) {
            req.query = {
                active: true,
                perpage: 100
            };
            ...
            return join(
                ...
                function (commonData, sportData) {
                    console.log('sports page data', testimonialData);
                    return {
                        commonData: commonData,
                        sportData: sportData.dataList
                    };
                });
