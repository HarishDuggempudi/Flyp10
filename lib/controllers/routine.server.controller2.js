var routineController = (function() {
    ...
    RoutineModule.Createcomment = function(commentObj, loggedInUser) {
        ...
        newComment.comment = commentObj.comment ? commentObj.comment.replace(/&amp;/g, "&") : '';
        newComment.overallComment = commentObj.comment ? commentObj.comment : '';
        newComment.time = commentObj.time;
        newComment.element = commentObj.element;
    ...
    _p.getsingleRoutineByID = function(req) {
        ...
        console.log(query)
            //console.log(dataProviderHelper.findAll(Routine,query))
        return dataProviderHelper.findById(Routine, req.params.routineid, routineFields);
    };
    ...
    _p.convertRoutineByName = function(req, res, next) {
        var completed = true;
        var routineScr = "/mnt/volume_sfo2_01/public/uploads/user/routine/" + req.query.filename;
        var convertfilename = "public/uploads/user/routine/" + path.parse(req.query.filename).name + '-converted.mp4';
        //var filename=path.parse(documentName).name;
                    ...
                    if (count > 0) {
                        ...
                        if (routineInfo._documentName) {
                            ...
                            if (fs.existsSync(routineScr)) {
                                ...
                                console.log('inside thumbnail if', routineScr)
                                try {
                                    ...
                                    console.log(e)
                                    console.log("exception occurred on thumpnail creation")
                                }

                            } else {
                                console.log('inside thumbnail else', routineScr)
                                try {
                        ...
                        return [newRoutine, dataProviderHelper.save(newRoutine).then(routineResponse => {
                            ...
                            console.log(req.body.eventlevel, req.body.sportid, req.body.uploadingType, applicationConfig.sports.MFigureSkating, req.body.technician)
                                //console.log(req.body.eventlevel == '1',req.body.sportid == applicationConfig.sports.WFigureSkating,)
                            if (req.body.eventlevel == '1' && (req.body.sportid == applicationConfig.sports.WFigureSkating || req.body.sportid == applicationConfig.sports.MFigureSkating)) {

                                if (req.body.uploadingType == '2' && req.body.technician) {
                                    let body = {
                                        eventId: eventMeetId._id,
                ...
                .then(function(count) {
                    ...
                    if (count > 1) {
                        ...
                        if (req.body.routinestatus == '1') {
                            ...
                            req.routinelist.comment = req.body.comment ? req.body.comment.replace(/&amp;/g, "&") : '';
                ...
                .then(function(count) {
                    ...
                    if (count > 1) {
                        ...
                        if (req.body.routinestatus == '1') {
                            ...
                            req.routinelists.comment = req.body.comment ? req.body.comment.replace(/&amp;/g, "&") : '';
