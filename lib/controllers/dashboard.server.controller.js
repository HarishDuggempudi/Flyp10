        ...
        analyticsController.getGoogleAnalyticsConfig()
            .then(function (googleAnalyticsObj) {
                if (googleAnalyticsObj && googleAnalyticsObj.docProperties && googleAnalyticsObj.docProperties.docPath) {
                   ...
                   // keyPath =   googleAnalyticsObj.docProperties.docPath.replace("/mnt/volume_sfo2_01/","");
                   // keyPath=keyPath.replace("/mnt/volume_sfo2_01","");
                    keyPath = "/mnt/volume_sfo2_01/" + googleAnalyticsObj.docProperties.docPath;
