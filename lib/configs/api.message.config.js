...
(function () {
    ...
    module.exports = {
		...
		pricingsetting:{
			savemessage:"Pricing settings saved successfully.",
			updatemessage:"Pricing settings updated successfully.",
			isalready:"Pricing settings already exists.",
			 validationErrMessage:{
                premium : "Premium subscription amount is required",
                premiumPlus : "Premium plus subscription amount is required",
                addCredits : "Add credits is required"
            }
		},
		notFound:{
			state:"Unable to load state info",
			city:"Unable to load city info",
			zip:"Unable to load zipcode info"
        ...
        commentSetting : {
            ...
            alreadyExistsCommentSetting : "comment setting already exists. You can only update the data once data is inserted. "
       		...
       		saveMessageBanner: "Banner saved successfully.",
            updateMessageBanner: "Banner updated successfully.",
            deleteMessageBanner: "Banner deleted successfully.",
            notFoundBanner: "Banner not found.",
            fieldRequiredBanner: "Banner title is required.",
            alreadyExistsBanner: "Banner with same platform already exists.",
            bannerDeleteDeny: "Banner cannot be deleted since it contains platform.",
        },card:{ 
       		save: "Card saved successfully.",       
            notFoundc: "Card not found.",
            fieldRequiredBanner: "Card token is required.",
            alreadyExistsCard: "Card with same token already exists.",   
            deleteMessage:"Card removed successfully.",
            DeleteDeny: "Default card cannot be deleted.",			
        },pricing:{ 
       		saveMessagePricing: "Sport pricing saved successfully.",
            updateMessagePricing: "Pricing updated successfully.",
            deleteMessagePricing: "Pricing deleted successfully.",
            notFoundPricing: "Pricing not found.",
            fieldRequiredPricing: "All fields are required.",
            alreadyExistsPricing: "Pricing with same sport and scoretype already exists.",
            PricingDeleteDeny: "Pricing cannot be deleted since it contains platform.",
        },element:{
            saveMessageElement: "Element saved successfully",
            updateMessageElement: "Element updated successfully",
            deleteMessageElement: "Element deleted successfully",
            notFoundElement: "Element not found",
            fieldRequiredElement: "Element name is required",
            alreadyExistsElement: "Element with same name already exists",
            elementDeleteDeny: "Element cannot be deleted since it contains Sports.",
        },
        faq:{
            saveMessagfaq: "Faq saved successfully",
            updateMessageFaq: "Faq updated successfully",
            deleteMessageFaq: "Faq deleted successfully",
            notFoundFaq: "Faq not found",
            fieldRequiredFaq: "Faq  question is required",
			fieldansRequiredFaq: "Faq  answer is required",
			fieldassignedToRequiredFaq:"Faq  assignedTo is required",
			RequiredFaq: "Faq  answer is required",
            alreadyExistsFaq: "Faq with same Question already exists",
            FaqDeleteDeny: "Faq cannot be deleted since it contains user.",
        },
		 Amount:{
            credit: "Amount credited successfully",
            debit: "Amount debited successfully",
			notfound:"User Not found"
        },
        level:{
            saveMessagelevel: "Level saved successfully",
            updateMessagelevel: "Level updated successfully",
            deleteMessagelevel: "Level deleted successfully",
            notFoundlevel: "Level not found",
            fieldRequiredlevel: "Level is required",
            alreadyExistslevel: "Level with same name already exists",
            levelDeleteDeny: "Level cannot be deleted since it contains Sports.",
        },
        routine:{
            saveMessageroutine: "Routine uploaded successfully",
            updateMessageroutine: "Routine updated successfully",
            deleteMessageroutine: "Routine deleted successfully",
            notFoundroutine: "Routine not found",
            fieldRequiredroutine: "Routine is required",
            alreadyExistsroutine: "Routine with same title already exists",
            routineDeleteDeny: "Routine cannot be deleted since it already assigned to judge.",
        },
        JudgeSport:{
            saveMessageJudgeSport: "User Sport saved successfully",
            updateMessageJudgeSport: "User Sport updated successfully",
            deleteMessageJudgeSport: "User Sport deleted successfully",
            notFoundJudgeSport: "User Sport not found",
            fieldRequiredJudgeSport: "User Sport is required",
            alreadyExistsJudgeSport: "User Sport with same name already exists",
            JudgeSportDeleteDeny: "User Sport cannot be deleted since it contains Sports.",
        },
        category:{
            saveMessagecategory: "category saved successfully",
            updateMessagecategory: "category updated successfully",
            deleteMessagecategory: "category deleted successfully",
            notFoundcategory: "category not found",
            fieldRequiredcategory: "category is required",
            alreadyExistscategory: "category with same name already exists",
            categoryDeleteDeny: "category cannot be deleted since it contains Sports.",
        },
        elementgroup:{
            saveMessageElementgroup: "Element group saved successfully",
            updateMessageElementgroup: "Element group updated successfully",
            deleteMessageElementgroup: "Element group deleted successfully",
            notFoundElementgroup: "Element group not found",
            fieldRequiredElementgroup: "Element group is required",
            alreadyExistsElementgroup: "Element group with same group already exists",
            elementDeleteDenygroup: "Element group cannot be deleted since it contains Sports.",
        },
        USAGYMAPI :{
         
            alreadySanctionExists :"Sanction with same SanctionID already exists",
            alreadyReservationExists :"Reservation with same SanctionID already exists"
        ...
        login:{
            ...
            ipBlocked : "Your login is temporarily suspended due to too many failed login attempts. Please try logging in with proper credentials after 10 minutes",
        ...
        sport:{
            saveMessage: "Sport saved successfully",
            updateMessage: "Sport updated successfully",
            deleteMessage: "Sport deleted successfully",
            alreadyExistsSport: "Sport with same name already exists",
            notFound: "Sport not found",
            validationErrMessage:{
                personName : "Person name is required",
                organization : "Organization name is required",
                emailValid : "Invalid Email",
        ...
        user:{
            ...
            signupuser:"You have signed up successfully",
            ...
            superAdminUpdateMessage: "superadmin cannot be updated",
            ...
            notAuthorizedForSecurityAnswerUpdate : "We don't recognize this Username. Please provide a valid username to proceed.",
