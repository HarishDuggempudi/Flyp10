(function (appllicationRoutes) {
    ...
    appllicationRoutes.init = function (app) {
        ...
        var sportInfoRouter = require('./sport.route');
        app.use('/api/', sportInfoRouter);

        var routineInfoRouter = require('./routine.route');
        app.use('/api/', routineInfoRouter);
        var promocodeRouter = require("./promocode.route");
        app.use(
          "/api/promocode/",
        ...
        var faqInfoRouter = require('./faq.route');
        app.use('/api/', faqInfoRouter);
		
		var convergeInfoRouter = require('./converge.route');
        app.use('/api/', convergeInfoRouter);
		
		var eventSportmeetRouter = require('./eventsportmeet.route');
        app.use('/api/', eventSportmeetRouter);
        ...
        var notificationRouter = require('./notification.management.route');
        ...
        // var EventInfoRouter = require('./event.management.route');
        // app.use('/api/event', EventInfoRouter);
        ...
        var usagGYMRouter = require('./usa.gym.api.route');
        app.use('/api/', usagGYMRouter);
