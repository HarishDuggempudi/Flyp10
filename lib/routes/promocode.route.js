var promocodeRoutes = (function () {
  ...
  var HTTPStatus = require("http-status"),
    ...
    promocodeController = require("../controllers/promocode.control"),
  ...
  promocodeRouter
    ...
    .post(promocodeController.postRoleInfo);
  ...
  promocodeRouter
    ...
    .get(promocodeController.getRoleById)
    ...
    .patch(promocodeController.deleteRoleInfo)
    ...
    .put(promocodeController.updateRoleInfo);
    ...
    promocodeController
      ...
      .then(function (roles) {
        if (roles) {
          ...
          res.json({
            message: messageConfig.promocode.notFound,
          });
        }
      })
      .catch(function (err) {
